...
exports.createForObject = function(valueObject, thisObject, localId){
	...
	function runPhase(functName, args){
		var func = valueObject.phases[functName];
		if(func){
	...
	function valueOf(){
		...
		ret.public          = valueObject.public;
		ret.local         = valueObject.local;
		ret.secure       = valueObject.secure;
		return ret;
	}
